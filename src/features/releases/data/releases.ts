...
export const RELEASES: ReleaseEntry[] = [
  {
    ...
    version: "2026.08",
    date: "2026-08-11",
    title: "El asistente ya sabe en qué estás trabajando",
    summary: "Specs 050 y 048: el asistente toma el contexto del proyecto y la tarea que tienes abiertos, para que avances sin repetir información.",
    changes: [
      { kind: "feature", text: "El asistente recibe el proyecto, la tarea, el estado y la prioridad que estás viendo." },
      { kind: "feature", text: "Acciones rápidas, sugerencias para seguir y comandos como /resumen, /vencidos, /salud y /crear-tarea." },
      { kind: "improvement", text: "Puedes copiar respuestas, regenerarlas o reintentar un turno que falló sin volver a escribir todo." },
      { kind: "improvement", text: "Menos llamados innecesarios y conversaciones más livianas: los atajos evitan RAG y el historial se limita a 12 entradas." },
    ],
  },
  {
    ...
    summary: "Spec 049: ajustes para que los modelos compatibles, el cambio de claves y los errores de las herramientas funcionen como esperas.",
    changes: [
      { kind: "feature", text: "Los modelos personalizados de proveedores compatibles con OpenAI llegan al proveedor correcto." },
